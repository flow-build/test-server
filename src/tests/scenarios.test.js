...
describe('GET /workflow/:id/scenarios', () => {
  test('should return 200', async () => {

    const response = await request.get('/workflow/8a126b08-f5e2-48a8-b913-d201ac6ca409/scenarios')
  ...
  test('should return 400 for invalid uuid', async () => {
    ...
    const response = await request.get('/workflow/8a126b08/scenarios')
  ...
  test('should return 404 for workflow not found', async () => {
    ...
    const response = await request.get('/workflow/7a126b08-f5e2-48a8-b913-d201ac6ca408/scenarios')
...
describe('PATCH /workflow/:workflow_id/scenarios/:scenario_id', () => {
  test('should return 200', async () => {

    const response = await request
      .patch('/workflow/8a126b08-f5e2-48a8-b913-d201ac6ca409/scenarios/0')
  ...
  test('should return 400 for invalid uuid', async () => {
    ...
    const response = await request
      .patch('/workflow/7a126b08/scenarios/0')
      .send({ name: 'Happy Path' });
  ...
  test('should return 404 for workflow not found', async () => {
    ...
    const response = await request
      .patch('/workflow/7a126b08-f5e2-48a8-b913-d201ac6ca408/scenarios/0')
      .send({ name: 'Happy Path' });
  ...
  test('should return 404 for scenario not found', async () => {
    ...
    const response = await request
      .patch('/workflow/8a126b08-f5e2-48a8-b913-d201ac6ca409/scenarios/1')
      .send({ name: 'Happy Path' });
  ...
  test('should return 400 invalid request body', async () => {
